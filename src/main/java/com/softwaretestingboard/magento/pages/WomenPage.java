...
public class WomenPage extends Utility {
    ...
    public void selectFiletrFromDropDownList() {
        ...
        selectByValueFromDropDown(selectByFilterPrice, "name");
    }
    @CacheLookup
    ...
    public ArrayList<String> defaultProductList() {
        ...
        log.info("get product name and store in array list" + productList.toString());
    ...
    public ArrayList<String> afterSortingByProductName() {
        ...
        log.info("after sort jacket list" + productList.toString());
